...
import cwbuild.block.tempblock.SizeTempBlockRequirement;
import cwbuild.config.InputBuilderConfiguration;
import cwbuild.file.InputFile;
import cwbuild.termprocessors.ITermProcessor;
import cwbuild.utils.BlockWriter;
import cwbuild.utils.FileIDWriter;
import cwbuild.utils.FilePathStreamUtil;
import cwbuild.worker.BlockConsumer_BlockWriter;
import cwbuild.worker.FileConsumer_BlockProducer;
import cwbuild.worker.FileProducer_FromFileList;
import cwbuild.worker.FileProducer_FromRoot;
